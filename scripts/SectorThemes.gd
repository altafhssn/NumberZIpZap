...
#
# Level -> pack mapping (mirrors BoxSelect.gd):
#   Spark    (1-10)   5x5  amber / gold       — friendly opening
#   Glow     (11-20)  6x6  orange sunset      — warmer, more saturated
#   Ember    (21-30)  7x7  volcanic red       — molten-gold ribbon
#   Nova     (31-40)  8x8  cosmic violet      — ribbon hue rotates live
#   Infinite (41+)    9x9  cyan void          — ribbon hue cycles per level
class_name SectorThemes
extends RefCounted

const PACK_NAMES := ["Spark", "Glow", "Ember", "Nova", "Infinite"]
const PACK_LAST := [10, 20, 30, 40, 99999]
